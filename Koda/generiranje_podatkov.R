...
#2) generiramo s pomoƒçjo geometrijskih grafov
#a) Ëe ima geometrijski graf take utezi kot je razdalja
...
#b) utez je inverz povezave (se pravi bliûje sta toËki, veËja je uteû)



#c) utezi so na povezavah nakljuËno izbrane 
